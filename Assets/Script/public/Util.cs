...
public class Util : MonoBehaviour
{
    ...
    public static readonly WaitForSecondsRealtime delay4RT = new WaitForSecondsRealtime(4f);
    public static readonly WaitForSeconds delay9 = new WaitForSeconds(9f);
