...
//*---------------------------------------
    public void createBatHitSparkEF(Vector3 parentPos){
        ...
        StartCoroutine(ObjectPool.coDestroyObject(ins, effectGroup, 1));
    }
    ...
    public void createBrokeBlockEF(Vector3 parentPos, Color color){
        ...
        StartCoroutine(ObjectPool.coDestroyObject(ins, effectGroup, main.duration));
    }
    public void createItemBlockExplosionEF(Vector3 parentPos){
        ...
        StartCoroutine(ObjectPool.coDestroyObject(ins, effectGroup, 1.5f));
    }
    public void createItemBlockDirLineTrailEF(Vector3 parentPos, Vector3 dir){
        ...
        StartCoroutine(ObjectPool.coDestroyObject(ins, effectGroup, 3));
    }
...
//* -------------------------------------------------------------
    ...
    public GameObject createAtvSkExplosionEF(int idx, Transform parentTf, int time = 2){
        ...
        StartCoroutine(ObjectPool.coDestroyObject(ins, effectGroup, time));
        return ins;
    }
...
//* -------------------------------------------------------------
    public void createDropItemExpOrbEF(Transform parentTf){
        var ins = ObjectPool.getObject(ObjectPool.DIC.DropItemExpOrbEF.ToString(), parentTf.position, QI, effectGroup);
        StartCoroutine(ObjectPool.coDestroyObject(ins, effectGroup, 1.5f));
    }
//* -------------------------------------------------------------
//* UI EF
